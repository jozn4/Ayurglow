...
// Fetch only PACKAGE booking requests with pending or accepted status
$sql = "SELECT r.request_id, r.psid, r.customer_id, r.type, r.status, r.required_date,
        ...
        INNER JOIN tbl_package p ON r.psid = p.package_id
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Package Booking Requests</h2>
